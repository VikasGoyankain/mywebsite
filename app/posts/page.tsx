...
export default function Posts() {
  ...
  return (
    <div className="relative">      {/* Main Page Button - Top Position */}
      <div className="container mx-auto px-4">
        <div className="absolute top-4 left-4">
          <Button
            onClick={() => router.push('/')}
            variant="ghost"
            className="bg-white/80 hover:bg-white dark:bg-neutral-800/80 dark:hover:bg-neutral-800 shadow-md backdrop-blur-sm transition-all"
            size="sm"
          >
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100 dark:from-neutral-900 dark:to-neutral-800">
